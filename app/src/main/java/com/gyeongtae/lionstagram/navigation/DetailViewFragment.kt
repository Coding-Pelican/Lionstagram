...
class DetailViewFragment : Fragment(){
    ...
    inner class DetailViewRecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        inner class CustomViewHolder(var viewBinding: ItemDetailBinding) : RecyclerView.ViewHolder(viewBinding.root)

        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            var customViewHolder = holder as CustomViewHolder

            //UserId
            customViewHolder.viewBinding.detailviewitemTvProfileText.text = contentDTOs!![position].userId

            //Image
            Glide.with(holder.itemView.context).load(contentDTOs!![position].imageUri).into(customViewHolder.viewBinding.detailviewitemIvContent)

            //Explain of content
            customViewHolder.viewBinding.detailviewitemTvExplain.text = contentDTOs!![position].explain

            //likes
            customViewHolder.viewBinding.detailviewitemTvFavoritecounter.text = "Likes" + contentDTOs!![position].favoriteCount

            //Profile Image
            Glide.with(holder.itemView.context).load(contentDTOs!![position].imageUri).into(customViewHolder.viewBinding.detailviewitemIvProfileImg)
        }
